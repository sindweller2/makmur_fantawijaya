...
<%@ Register Src="forms/PopUp/popup_produk_item.ascx" TagName="popup_produk_item" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            Me.popup_produk_item1.loadgrid()
        End If
    End Sub
    ...
    Protected Sub popup_produk_item1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_produk_item1_ProdukClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_produk_item1.id_produk)
        Me.ltl_js.Text += Me.CloseString
    End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_produk_item ID="popup_produk_item1" runat="server" OnCloseClicked="popup_produk_item1_CloseClicked" OnProdukClicked="popup_produk_item1_ProdukClicked" />
</asp:Content>