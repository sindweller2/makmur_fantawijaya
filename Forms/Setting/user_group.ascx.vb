...
Partial Class Forms_Setting_user_group
    ...
    Sub loadgrid()
        Try
            ...
            Using con
                ...
                Me.dg_data.DataSource = ds.Tables("user_group").DefaultView

                If ds.Tables("user_group").Rows.Count > 0 Then
                    If ds.Tables("user_group").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi nama grup user terlebih dahulu"
            Else
                Dim vmax As Integer = 0

                sqlcom = "select isnull(max(code),0) + 1 as vmax from user_group"
                ...
                sqlcom = "insert into user_group(code, name)"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "delete user_group where code = " & CType(Me.dg_data.Items(x).FindControl("lbl_kode"), Label).Text
