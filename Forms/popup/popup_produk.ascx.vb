...
Partial Class Forms_Popup_popup_produk
    ...
    Private ReadOnly Property vid_sales() As Integer
        Get
            Dim o As Object = Request.QueryString("vid_sales")
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " and id_category in (select id_category from product_category_sales where code_pegawai = " & Me.vid_sales & ")"
