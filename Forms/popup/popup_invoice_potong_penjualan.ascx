<%@ Control Language="VB" AutoEventWireup="false" CodeFile="popup_invoice_potong_penjualan.ascx.vb" Inherits="Forms_Popup_popup_invoice_potong_penjualan" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl1" Text="Daftar Invoice Penjualan" Font-Names="Tahoma" Font-Size="12" Font-Bold="true" /></td>
    </tr>
</table>
    ...
    <tr>
        <td>
            <table runat="server" id="tbl_search">
                <tr>
                    <td><asp:Label runat="server" ID="lb012" Text="No. Penjualan" Font-Names="Tahoma" Font-Size="8pt" />
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_alamat" Text="No. Penjualan" Font-Names="Tahoma" Font-Size="8pt" Width="350" />
                        </HeaderTemplate>
                        <ItemTemplate>
