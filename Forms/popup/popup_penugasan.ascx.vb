...
Partial Class Forms_Popup_popup_penugasan
    Inherits System.Web.UI.UserControl

    Public Event CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
    Public Event PenugasanClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)

    Dim reader As SqlClient.SqlDataReader
    Dim sqlcom As String

    Public Property id_penugasan() As Integer
        Get
            Dim o As Object = ViewState("id_penugasan")
            If Not o Is Nothing Then Return CInt(o) Else Return 0
        End Get
        Set(ByVal value As Integer)
            ViewState("id_penugasan") = value
        End Set
    End Property
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = "select seq, no_aju, daftar_expedition.name as nama_ekspedisi"
            ...
            If String.IsNullOrEmpty(Me.tb_search.Text) Then
                sqlcom = sqlcom
            Else
                sqlcom = sqlcom + " and upper(no_aju) like upper('%" & Me.tb_search.Text & "%')"
            End If
            sqlcom = sqlcom + " order by no_aju"
            ...
            Using con
                ...
                If ds.Tables("penugasan_ekspedisi_impor").Rows.Count > 0 Then
                    If ds.Tables("penugasan_ekspedisi_impor").Rows.Count > 10 Then
    ...
    Protected Sub dg_data_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dg_data.ItemCommand
        If e.CommandName = "LinkItem" Then
            Me.id_penugasan = CType(e.Item.FindControl("lbl_id"), Label).Text
            RaiseEvent PenugasanClicked(source, e)
        End If
    End Sub
