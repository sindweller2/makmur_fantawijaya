...
Partial Class Forms_Popup_popup_produk_retur
    ...
    Private ReadOnly Property vno_penjualan() As Integer
        Get
            Dim o As Object = Request.QueryString("vno_penjualan")
    ...
    Sub bindpenjualan()
        Try
            sqlcom = "select so_no_text"
            sqlcom = sqlcom + " from sales_order"
            sqlcom = sqlcom + " where no = " & Me.vno_penjualan
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " isnull(sales_order_detail.qty,0) as qty, isnull(sales_order_detail.harga_jual,0) as harga_jual"
            ...
            sqlcom = sqlcom + " where sales_order_detail.no_sales_order = " & Me.vno_penjualan
