...
Partial Class Forms_Popup_popup_coa
    Inherits System.Web.UI.UserControl

    Public Event CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
    Public Event COAClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)

    Dim reader As SqlClient.SqlDataReader
    Dim sqlcom As String

    Public Property id_coa() As String
        Get
            Dim o As Object = ViewState("id_coa")
            If Not o Is Nothing Then Return CStr(o) Else Return Nothing
        End Get
        Set(ByVal value As String)
            ViewState("id_coa") = value
        End Set
    End Property
    ...
    Sub loadgrid()
        Try
            ...
            If String.IsNullOrEmpty(Me.tb_search.Text) Then
                sqlcom = sqlcom
            Else
                sqlcom = sqlcom + " and upper(inaname) like upper('%" & Me.tb_search.Text & "%')"
            End If
    ...
    Protected Sub dg_data_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dg_data.ItemCommand
        If e.CommandName = "LinkItem" Then
            Me.id_coa = CType(e.Item.FindControl("lbl_code"), Label).Text
            RaiseEvent COAClicked(source, e)
        End If
    End Sub
