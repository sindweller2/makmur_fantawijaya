<%@ Control Language="VB" AutoEventWireup="false" CodeFile="popup_ekspedisi_impor.ascx.vb" Inherits="Forms_Popup_popup_ekspedisi_impor" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl1" Text="Daftar Ekspedisi Impor" Font-Names="Tahoma" Font-Size="12" Font-Bold="true" /></td>
    </tr>
</table>
    ...
    <tr>
        <td>
            <table width="600">
                <tr>
                    <td>
                        <asp:Label runat="server" ID="lbl2" Text="Nama Ekspedisi" Font-Names="Tahoma" Font-Size="8pt" />
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_nama" Text="Nama Ekspedisi" Font-Names="Tahoma" Font-Size="8pt" Width="150" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_alamat" Text="Alamat" Font-Names="Tahoma" Font-Size="8pt" Width="250" />
                        </HeaderTemplate>
                        <ItemTemplate>
                        <asp:Label runat="server" ID="lbl_alamat" Text='<%#Databinder.Eval(Container, "Dataitem.alamat") %>' Font-Names="Tahoma" Font-Size="8pt" />
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
            </asp:DataGrid>
