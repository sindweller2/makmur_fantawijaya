<%@ Control Language="VB" AutoEventWireup="false" CodeFile="popup_customer_do.ascx.vb" Inherits="Forms_Popup_popup_customer_do" %>
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_nama" Text="Nama customer" Font-Names="Tahoma" Font-Size="8pt" Width="450" />
                        </HeaderTemplate>
                        <ItemTemplate>
