...
Partial Class Forms_Popup_popup_ekspedisi_impor
    Inherits System.Web.UI.UserControl

    Public Event CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
    Public Event EkspedisiClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        ...
        Try
            ...
            Using con
                ...
                If ds.Tables("daftar_expedition").Rows.Count > 0 Then
                    If ds.Tables("daftar_expedition").Rows.Count > 10 Then
    ...
    Protected Sub dg_data_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dg_data.ItemCommand
        If e.CommandName = "LinkItem" Then
            Me.id_ekspedisi = CType(e.Item.FindControl("lbl_id"), Label).Text
            RaiseEvent EkspedisiClicked(source, e)
        End If
    End Sub
