<%@ Control Language="VB" AutoEventWireup="false" CodeFile="popup_dokumen_impor_bdp.ascx.vb" Inherits="Forms_Popup_popup_dokumen_impor_bdp" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="Label2" Text="Periode" Font-Names="Tahoma" Font-Size="8pt" /></td>
        <td><asp:Label runat="server" ID="Label3" Text=":" Font-Names="Tahoma" Font-Size="8pt" /></td>
        <td><asp:Label runat="server" ID="lbl_nama_periode" Font-Names="Tahoma" Font-Size="8pt" /></td>
    </tr>
</table>
