<%@ Control Language="VB" AutoEventWireup="false" CodeFile="jenis_kendaraan.ascx.vb" Inherits="Forms_Masterfile_gudang_jenis_kendaraan" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Daftar Jenis Kendaraan" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl100" Text="Nama jenis kendaraan" Font-Names="Tahoma" Font-Size="8" /></td>
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_name" Text="Nama jenis kendaraan" Width="250" Font-Names="Tahoma" Font-Size="8" />
                        </HeaderTemplate>
                        <ItemTemplate>
