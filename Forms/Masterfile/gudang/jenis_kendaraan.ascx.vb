...
Partial Class Forms_Masterfile_gudang_jenis_kendaraan
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " from jenis_vehicle"
            ...
            Using con
                con.Open()
                da.Fill(ds, "jenis_vehicle")
                Me.dg_data.DataSource = ds.Tables("jenis_vehicle").DefaultView

                If ds.Tables("jenis_vehicle").Rows.Count > 0 Then
                    If ds.Tables("jenis_vehicle").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi nama jenis kendaraan terlebih dahulu"
            Else
                Dim vmax As Integer = 0
                sqlcom = "select isnull(max(id),0) + 1 as vmax from jenis_vehicle"
                ...
                sqlcom = "insert into jenis_vehicle(id, name)"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "delete jenis_vehicle where id = " & CType(Me.dg_data.Items(x).FindControl("lbl_id"), Label).Text
