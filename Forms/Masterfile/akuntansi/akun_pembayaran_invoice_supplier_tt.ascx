<%@ Control Language="VB" AutoEventWireup="false" CodeFile="akun_pembayaran_invoice_supplier_tt.ascx.vb" Inherits="Forms_Masterfile_akun_pembayaran_invoice_supplier_tt" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Akun Pembayaran Invoice Supplier TT" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    ...
    <tr>
        <td><asp:Label runat="server" ID="Label7" Text="Akun hutang dagang masing-masing supplier" Font-Names="Tahoma" Font-Size="8" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>        
    <tr>
