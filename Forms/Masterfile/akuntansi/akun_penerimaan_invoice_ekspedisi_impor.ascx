<%@ Control Language="VB" AutoEventWireup="false" CodeFile="akun_penerimaan_invoice_ekspedisi_impor.ascx.vb" Inherits="Forms_Masterfile_akun_penerimaan_invoice_ekspedisi_impor" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Akun Penerimaan Invoice Ekspedisi Impor" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    ...
    <tr>
        ...
        <td width="350"><asp:Label runat="server" ID="lbl_akun_biaya_impor" Font-Names="Tahoma" Font-Size="8" />
            <asp:TextBox runat="server" ID="tb_id_akun_biaya_impor" Font-Names="Tahoma" Font-Size="8pt"/>
            <asp:LinkButton runat="server" ID="link_refresh_akun_biaya_impor" Text="Refresh"/>
            <asp:LinkButton runat="server" ID="link_popup_akun_biaya_impor" Text="Daftar COA" Font-Names="Tahoma" Font-Size="8pt"/>
        </td>
    </tr>
    <tr>
        <td><asp:Label runat="server" ID="Label256" Text="Akun PPN Masukan" Font-Names="Tahoma" Font-Size="8" /></td>
        <td><asp:Label runat="server" ID="Label356" Text=":" Font-Names="Tahoma" Font-Size="8" /></td>
    ...
    <tr>
        <td><asp:Label runat="server" ID="Label6" Text="Akun hutang lain-lain masing-masing ekspedisi" Font-Names="Tahoma" Font-Size="8" /></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
</table>
