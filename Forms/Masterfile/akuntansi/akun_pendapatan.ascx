<%@ Control Language="VB" AutoEventWireup="false" CodeFile="akun_pendapatan.ascx.vb" Inherits="Forms_Masterfile_akun_pendapatan" %>


<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Akun Pendapatan" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl1" Text="Nama pendapatan" Font-Names="Tahoma" Font-Size="8" /></td>
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_name" Text="Nama pendapatan" Width="200" Font-Names="Tahoma" Font-Size="8pt"/>
                        </HeaderTemplate>
                        <ItemTemplate>
