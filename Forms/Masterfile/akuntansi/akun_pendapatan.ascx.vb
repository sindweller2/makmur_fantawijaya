...
Partial Class Forms_Masterfile_akun_pendapatan
    ...
    Sub bindcoabiaya()
        ...
        sqlcom = sqlcom + " where inaname like 'PENDAPATAN%'"
    ...
    Sub loadgrid()
        Try
            ...
            Using con
                con.Open()
                da.Fill(ds, "item_pendapatan")
                Me.dg_data.DataSource = ds.Tables("item_pendapatan").DefaultView

                If ds.Tables("item_pendapatan").Rows.Count > 0 Then
                    If ds.Tables("item_pendapatan").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi nama pendapatan terlebih dahulu"
            Else
                Dim vmax As Integer = 0
                sqlcom = "select isnull(max(id),0) + 1 as vmax from item_pendapatan"
                reader = connection.koneksi.SelectRecord(sqlcom)
                reader.Read()
                ...
                sqlcom = "insert into item_pendapatan(id, name, account_code)"
