<%@ Control Language="VB" AutoEventWireup="false" CodeFile="akun_biaya_non_lc.ascx.vb" Inherits="Forms_Masterfile_akun_biaya_non_lc" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Akun Biaya Bank Non L/C" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    ...
    <tr>
        <td><asp:Label runat="server" ID="Label2" Text="Akun biaya bank non L/C" Font-Names="Tahoma" Font-Size="8" /></td>
        <td><asp:Label runat="server" ID="Label3" Text=":" Font-Names="Tahoma" Font-Size="8" /></td>
        <td width="350"><asp:Label runat="server" ID="lbl_akun_biaya_bank" Font-Names="Tahoma" Font-Size="8" />
            <asp:TextBox runat="server" ID="tb_id_akun_biaya_bank" Font-Names="Tahoma" Font-Size="8pt"/>
            <asp:LinkButton runat="server" ID="link_refresh_akun_biaya_bank" Text="Refresh"/>
            <asp:LinkButton runat="server" ID="link_popup_akun_biaya_bank" Text="Daftar COA" Font-Names="Tahoma" Font-Size="8pt"/>
        </td>
    </tr>        
    <tr>
        <td>&nbsp;</td>
