...
Partial Class Forms_Masterfile_Purchasing_jenis_pembayaran_import
    ...
    Sub loadgrid()
        Try
            ...
            Using con
                ...
                Me.dg_data.DataSource = ds.Tables("payment_type").DefaultView

                If ds.Tables("payment_type").Rows.Count > 0 Then
                    If ds.Tables("payment_type").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi jenis pembayaran import terlebih dahulu"
            Else
                Dim vmax As Integer = 0
                sqlcom = "select isnull(max(id),0) + 1 as vmax from payment_type"
                ...
                sqlcom = "insert into payment_type(id, name)"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "delete payment_type where id = " & CType(Me.dg_data.Items(x).FindControl("lbl_id"), Label).Text
