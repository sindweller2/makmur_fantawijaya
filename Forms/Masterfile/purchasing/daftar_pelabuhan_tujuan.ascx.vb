...
Partial Class Forms_Masterfile_Purchasing_bidang_usaha_customer
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " from port_of_destination"
            ...
            Using con
                con.Open()
                da.Fill(ds, "port_of_destination")
                Me.dg_data.DataSource = ds.Tables("port_of_destination").DefaultView

                If ds.Tables("port_of_destination").Rows.Count > 0 Then
                    If ds.Tables("port_of_destination").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi nama pelabuhan terlebih dahulu"
            Else
                Dim vmax As Integer = 0
                sqlcom = "select isnull(max(id),0) + 1 as vmax from port_of_destination"
                ...
                sqlcom = "insert into port_of_destination(id, name)"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "delete port_of_destination where id = " & CType(Me.dg_data.Items(x).FindControl("lbl_id"), Label).Text
    ...
    Protected Sub btn_update_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_update.Click
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "update port_of_destination"
