<%@ Control Language="VB" AutoEventWireup="false" CodeFile="hs_no_produk.ascx.vb" Inherits="Forms_Masterfile_Pembelian_hs_no_produk" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Daftar HS no. Produk" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
