...
Partial Class Forms_Masterfile_Purchasing_daftar_jenis_kontainer
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " from ukuran_container"
            ...
            Using con
                con.Open()
                da.Fill(ds, "ukuran_container")
                Me.dg_data.DataSource = ds.Tables("ukuran_container").DefaultView

                If ds.Tables("ukuran_container").Rows.Count > 0 Then
                    If ds.Tables("ukuran_container").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi ukuran kontainer terlebih dahulu"
            Else
                Dim vmax As Integer = 0
                sqlcom = "select isnull(max(id),0) + 1 as vmax from ukuran_container"
                ...
                sqlcom = "insert into ukuran_container(id, name)"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "delete ukuran_container where id = " & CType(Me.dg_data.Items(x).FindControl("lbl_id"), Label).Text
    ...
    Protected Sub btn_update_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_update.Click
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "update ukuran_container"
