<%@ Control Language="VB" AutoEventWireup="false" CodeFile="daftar_jenis_kontainer.ascx.vb" Inherits="Forms_Masterfile_Purchasing_daftar_jenis_kontainer" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Daftar Jenis Kontainer" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl100" Text="Jenis kontainer" Font-Names="Tahoma" Font-Size="8" /></td>
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_name" Text="Jenis kontainer" Width="200" Font-Names="Tahoma" Font-Size="8" />
                        </HeaderTemplate>
                        <ItemTemplate>
