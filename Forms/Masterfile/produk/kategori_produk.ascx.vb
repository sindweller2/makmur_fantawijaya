...
Partial Class Forms_Masterfile_produk_kategori_produk
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " from product_category"
            ...
            Using con
                ...
                Me.dg_data.DataSource = ds.Tables("product_category").DefaultView

                If ds.Tables("product_category").Rows.Count > 0 Then
                    If ds.Tables("product_category").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi nama kategori produk terlebih dahulu"
            Else
                Dim vmax As Integer = 0
                sqlcom = "select isnull(max(id),0) + 1 as vmax from product_category"
                ...
                sqlcom = "insert into product_category(id, name)"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "delete product_category where id = " & CType(Me.dg_data.Items(x).FindControl("lbl_id"), Label).Text
    ...
    Protected Sub btn_update_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_update.Click
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "update product_category"
    ...
    Protected Sub dg_data_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dg_data.ItemCommand
        If e.CommandName = "LinkItem" Then
            Response.Redirect("~/product_sub_category.aspx?vid_category=" & CType(e.Item.FindControl("lbl_id"), Label).Text)
        ElseIf e.CommandName = "LinkSales" Then
            Response.Redirect("~/product_category_sales.aspx?vid_category=" & CType(e.Item.FindControl("lbl_id"), Label).Text)
        End If
    End Sub
