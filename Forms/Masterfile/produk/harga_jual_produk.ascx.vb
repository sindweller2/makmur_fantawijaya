...
Partial Class Forms_Masterfile_produk_harga_jual_produk
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " case"
            sqlcom = sqlcom + " when product_item.is_packaging = 'Q' then satuan_produk.name"
            sqlcom = sqlcom + " when product_item.is_packaging = 'P' then satuan_packaging_produk.name"
            ...
            sqlcom = sqlcom + " isnull(product_price.harga_jual,0) as harga_jual, product_price.id_currency,"
            sqlcom = sqlcom + " case"
            ...
            ElseIf Me.rad_full.Checked = True Then
                sqlcom = sqlcom + " and product_price.harga_jual <> 0"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked = True Then
                    ...
                    sqlcom = sqlcom + " set harga_jual = " & Decimal.ToDouble(CType(Me.dg_data.Items(x).FindControl("tb_harga_jual"), TextBox).Text)
