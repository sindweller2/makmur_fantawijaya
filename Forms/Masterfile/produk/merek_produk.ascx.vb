...
Partial Class Forms_Masterfile_produk_merek_produk
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " from product_brand"
            ...
            Using con
                ...
                Me.dg_data.DataSource = ds.Tables("product_brand").DefaultView

                If ds.Tables("product_brand").Rows.Count > 0 Then
                    If ds.Tables("product_brand").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi nama merek produk terlebih dahulu"
            Else
                Dim vmax As Integer = 0
                sqlcom = "select isnull(max(id),0) + 1 as vmax from product_brand"
                ...
                sqlcom = "insert into product_brand(id, name)"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "delete product_brand where id = " & CType(Me.dg_data.Items(x).FindControl("lbl_id"), Label).Text
