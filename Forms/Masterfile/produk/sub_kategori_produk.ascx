<%@ Control Language="VB" AutoEventWireup="false" CodeFile="sub_kategori_produk.ascx.vb" Inherits="Forms_Masterfile_produk_sub_kategori_produk" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Sub kategori produk" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    ...
    <tr>
        <td><asp:Label runat="server" ID="lbl100" Text="Nama sub kategori produk" Font-Names="Tahoma" Font-Size="8" /></td>
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_name" Text="Nama sub kategori produk" Width="200" Font-Names="Tahoma" Font-Size="8" />
                        </HeaderTemplate>
                        <ItemTemplate>
