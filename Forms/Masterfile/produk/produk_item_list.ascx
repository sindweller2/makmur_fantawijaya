<%@ Control Language="VB" AutoEventWireup="false" CodeFile="produk_item_list.ascx.vb" Inherits="Forms_Masterfile_produk_produk_item_list" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Daftar Item Produk" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    ...
    <tr>
        ...
        <td><asp:DropDownList runat="server" ID="dd_sub_category" Font-Names="Tahoma" Font-Size="8" AutoPostBack="true" />
            <asp:Button runat="server" ID="btn_new" Text="Produk baru" Font-Size="8" />
            ...
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        ...
                        <ItemTemplate>
                            <asp:LinkButton runat="server" ID="lbl_name" Text='<%#Databinder.Eval(Container, "Dataitem.nama_beli") %>' CommandName="LinkItem" Font-Names="Tahoma" Font-Size="8pt"/>                            
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
