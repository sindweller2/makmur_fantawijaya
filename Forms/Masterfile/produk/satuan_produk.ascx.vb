...
Partial Class Forms_Masterfile_produk_satuan_produk
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " from measurement_unit"
            ...
            Using con
                con.Open()
                da.Fill(ds, "measurement_unit")
                Me.dg_data.DataSource = ds.Tables("measurement_unit").DefaultView
                
                If ds.Tables("measurement_unit").Rows.Count > 0 Then
                    If ds.Tables("measurement_unit").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi nama satuan produk terlebih dahulu"
            Else
                Dim vmax As Integer = 0
                sqlcom = "select isnull(max(id),0) + 1 as vmax from measurement_unit"
                ...
                sqlcom = "insert into measurement_unit(id, name)"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "delete measurement_unit where id = " & CType(Me.dg_data.Items(x).FindControl("lbl_id"), Label).Text
    ...
    Protected Sub btn_update_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_update.Click
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "update measurement_unit"
