...
Partial Class Forms_Masterfile_customer_daftar_kota
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " from daftar_kota"
            ...
            Using con
                con.Open()
                da.Fill(ds, "daftar_kota")
                Me.dg_data.DataSource = ds.Tables("daftar_kota").DefaultView

                If ds.Tables("daftar_kota").Rows.Count > 0 Then
                    If ds.Tables("daftar_kota").Rows.Count > 10 Then
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        Try
            If String.IsNullOrEmpty(Me.tb_name.Text) Then
                Me.lbl_msg.Text = "Silahkan mengisi nama nama kota terlebih dahulu"
            Else
                Dim vmax As Integer = 0
                sqlcom = "select isnull(max(id),0) + 1 as vmax from daftar_kota"
                ...
                sqlcom = "insert into daftar_kota(id, name)"
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked Then
                    sqlcom = "delete daftar_kota where id = " & CType(Me.dg_data.Items(x).FindControl("lbl_id"), Label).Text
