...
Partial Class Forms_Transaksi_Keuangan_daftar_penerimaan_uang_fin
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = "select id, convert(char, tgl_transaksi, 103) as tgl_transaksi, keterangan, is_submit,"
            sqlcom = sqlcom + " case"
    ...
    Protected Sub btn_new_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_new.Click
        Response.Redirect("~/detil_transaksi_penerimaan_uang_fin.aspx?vtahun=" & Me.tb_tahun.Text & "&vbulan=" & Me.bulan & "&vid_periode=" & Me.dd_bulan.SelectedValue)
    End Sub
    ...
    Protected Sub dg_data_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dg_data.ItemCommand
        If e.CommandName = "LinkItem" Then
            Response.Redirect("~/detil_transaksi_penerimaan_uang_fin.aspx?vid_transaksi=" & CType(e.Item.FindControl("lbl_id"), LinkButton).Text & "&vbulan=" & Me.bulan & "&vtahun=" & Me.tb_tahun.Text & "&vid_periode=" & Me.dd_bulan.SelectedValue)
        End If
    End Sub
