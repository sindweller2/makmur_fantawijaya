<%@ Control Language="VB" AutoEventWireup="false" CodeFile="pib_dokumen_impor.ascx.vb" Inherits="Forms_Transaksi_Keuangan_pib_dokumen_impor" %>
            ...
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        ...
                        <ItemTemplate>
                            <asp:LinkButton runat="server" ID="lbl_produk" Text="Detil" Width="50" Font-Names="Tahoma" Font-Size="8" CommandName="LinkProduk" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="center" />
                    </asp:TemplateColumn>
                </Columns>
