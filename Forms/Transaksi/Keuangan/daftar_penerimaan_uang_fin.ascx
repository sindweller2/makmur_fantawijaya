<%@ Control Language="VB" AutoEventWireup="false" CodeFile="daftar_penerimaan_uang_fin.ascx.vb" Inherits="Forms_Transaksi_Keuangan_daftar_penerimaan_uang_fin" %>
            ...
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        ...
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbl_tanggal" Text='<%#Databinder.Eval(Container, "Dataitem.tgl_transaksi") %>' Width="100" Font-Names="Tahoma" Font-Size="8" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="center" />
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
