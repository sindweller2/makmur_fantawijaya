<%@ Control Language="VB" AutoEventWireup="false" CodeFile="detil_transfer_antar_kas_fin.ascx.vb" Inherits="Forms_Transaksi_Keuangan_detil_transfer_antar_kas_fin" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="act" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Detil Transfer Antar Kas/Bank (Fin)" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    ...
    <tr>
        ...
        <act:CalendarExtender ID="ce_tgl_transfer" TargetControlID="tb_tgl_transfer" runat="server" Animated="true" Format="dd/MM/yyyy" ></act:CalendarExtender>
        </td>
        ...
        <act:CalendarExtender ID="ce_tgl_masuk" TargetControlID="tb_tgl_masuk" runat="server" Animated="true" Format="dd/MM/yyyy" ></act:CalendarExtender>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="300"><asp:TextBox runat="server" ID="tb_nilai_biaya_provisi" Width="75" Font-Names="Tahoma" Font-Size="8" />
            <ajax:FilteredTextBoxExtender runat="Server" ID="FilteredTextBoxExtender213" FilterType="custom, numbers" ValidChars="." TargetControlID="tb_nilai_biaya_provisi" />
                ...
                <td><asp:Label runat="server" ID="Label22" Text="No. Voucher" Font-Names="Tahoma" Font-Size="8"/></td>
        <td><asp:Label runat="server" ID="Label24" Text=":" Font-Names="Tahoma" Font-Size="8"/></td>
        <td><asp:TextBox runat="server" ID="tb_no_voucher" Font-Names="Tahoma" Font-Size="8" />
        </td>
    </tr>
    <tr>
