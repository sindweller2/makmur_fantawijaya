...
Partial Class Forms_Transaksi_Gudang_detil_transaksi_petty_cash
    ...
    Protected Sub btn_close_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_close.Click
        Response.Redirect("~/daftar_transaksi_kas_gudang.aspx?vtahun=" & Me.vtahun & "&vbulan=" & Me.vbulan & "&vpaging=" & Me.vpaging)
    End Sub
