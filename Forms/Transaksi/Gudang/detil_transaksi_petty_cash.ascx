<%@ Control Language="VB" AutoEventWireup="false" CodeFile="detil_transaksi_petty_cash.ascx.vb" Inherits="Forms_Transaksi_Gudang_detil_transaksi_petty_cash" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="act" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Detil Transaksi Kas Gudang" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
