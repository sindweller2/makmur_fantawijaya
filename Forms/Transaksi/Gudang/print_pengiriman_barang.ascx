<%@ Control Language="VB" AutoEventWireup="false" CodeFile="print_pengiriman_barang.ascx.vb" Inherits="Forms_Transaksi_Penjualan_print_pengiriman_barang" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Print Pengiriman Barang" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    ...
    <tr>
        <td><asp:Label runat="server" ID="lbl111" Text="No. penjualan" Font-Names="Tahoma" Font-Size="8"/></td>
...
<table align="center">
    <tr>
        <td><asp:Button runat="server" ID="btn_print" Text="Print DO (LittlePaper1)" Font-Names="Tahoma" Font-Size="8" /></td>
        <td><asp:Button runat="server" ID="btn_close" Text="Close" Font-Names="Tahoma" Font-Size="8" /></td>
    </tr>
</table>

<CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
    <Report FileName="reports\do_print.rpt"></Report>
