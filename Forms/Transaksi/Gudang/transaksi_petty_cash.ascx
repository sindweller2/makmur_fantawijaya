<%@ Control Language="VB" AutoEventWireup="false" CodeFile="transaksi_petty_cash.ascx.vb" Inherits="Forms_Transaksi_Gudang_transaksi_petty_cash" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Daftar Transaksi Kas Gudang" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
