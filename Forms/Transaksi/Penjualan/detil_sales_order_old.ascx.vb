        ...
        Try
            ...
            Else
                ...
                If Me.no_so = 0 Then
                    ...
                    sqlcom = sqlcom + "'" & vno_so_text & "','B', 'B','B', 'B','" & Me.dd_is_bonus.SelectedValue & "','" & Me.tb_po_no.Text & "')"
        ...
        Try
            ...
            If reader.HasRows Then
                if Me.dd_ppn.SelectedValue = "0" then
                    Me.lbl_total_nilai.Text = FormatNumber(reader.Item("vtotal_nilai").ToString, 2)
                else
                    Me.lbl_total_nilai.Text = FormatNumber(reader.Item("vtotal_nilai").ToString + reader.Item("vtotal_nilai").ToString * 0.1, 2)
                end if
            End If
            reader.Close()
            connection.koneksi.CloseKoneksi()
