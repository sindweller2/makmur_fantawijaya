<%@ Control Language="VB" AutoEventWireup="false" CodeFile="pengeluaran_sample.ascx.vb" Inherits="Forms_Transaksi_Penjualan_pengeluaran_sample" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Pengeluaran Sample" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    ...
    <tr>
        ...
        <td><asp:Label runat="server" ID="lbl_nama_sales" Font-Names="Tahoma" Font-Size="8" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="tb_kurs" Width="50" Font-Names="Tahoma" Font-Size="8" />
            ...
            <ajax:FilteredTextBoxExtender runat="Server" ID="FilteredTextBoxExtender232" FilterType="custom, numbers" ValidChars="." TargetControlID="tb_kurs" />
        </td>
    </tr>
    <tr>
...
<table align="center">
    <tr>
        <td>
            <table runat="server" id="tbl_search" width="975">
                <tr>
                    <td>
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_nama_customer" Text="Nama customer" Font-Names="Tahoma" Font-Size="8" Width="250" />
                        </HeaderTemplate>
                        <HeaderStyle HorizontalAlign="center" />
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbl_id_customer" Text='<%#Databinder.Eval(Container, "Dataitem.nama_customer") %>' Width="250" Font-Names="Tahoma" Font-Size="8"/>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_nama_sales" Text="Nama sales" Font-Names="Tahoma" Font-Size="8" Width="150" />
                        </HeaderTemplate>
                        <HeaderStyle HorizontalAlign="center" />
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbl_id_sales" Text='<%#Databinder.Eval(Container, "Dataitem.nama_pegawai") %>' Font-Names="Tahoma" Font-Size="8" Width="150"/>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_measurement" Text="Satuan" Font-Names="Tahoma" Font-Size="8" Width="50" />
                        </HeaderTemplate>
                        <HeaderStyle HorizontalAlign="center" />
                        <ItemTemplate>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_qty" Text="Qty" Font-Names="Tahoma" Font-Size="8" Width="50" />
                        </HeaderTemplate>
                        <HeaderStyle HorizontalAlign="center" />
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="tb_qty" Text='<%#Databinder.Eval(Container, "Dataitem.qty") %>' Width="50" Font-Names="Tahoma" Font-Size="8"/>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_kurs" Text="Kurs" Font-Names="Tahoma" Font-Size="8" Width="50" />
                        </HeaderTemplate>
                        <HeaderStyle HorizontalAlign="center" />
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="tb_kurs" Text='<%#Databinder.Eval(Container, "Dataitem.kurs") %>' Width="50" Font-Names="Tahoma" Font-Size="8"/>
