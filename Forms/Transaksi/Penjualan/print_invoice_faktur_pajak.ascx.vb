...
Partial Class Forms_Transaksi_Penjualan_print_invoice_faktur_pajak
    ...
    Protected Sub btn_print_faktur_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print_faktur.Click
        Try
            Dim reportPath As String

            reportPath = Server.MapPath("reports\faktur_pajak_print.rpt")
            ...
            oRD.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Server.MapPath("Pdf_files/faktur_pajak_print.pdf"))
            Dim vscript As String = ""
            vscript = "<script>" & vbCrLf
            vscript = vscript + "window.open('Pdf_files/faktur_pajak_print.pdf', '_blank', 'resizable=yes,scrollbars=yes');" & vbCrLf
    ...
    Protected Sub btn_print_invoice_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print_invoice.Click
        Try
            ...
            reportPath = Server.MapPath("reports\invoice_print.rpt")
            ...
            'For i = 0 To PrintDoc.PrinterSettings.PaperSizes.Count - 1
                'If PrintDoc.PrinterSettings.PaperSizes.Item(i).PaperName = "LittlePaper1" Then
            ...
            oExO = oRD.ExportOptions
            oExO.ExportDestinationType = CrystalDecisions.Shared.ExportDestinationType.DiskFile
            oRD.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Server.MapPath("Pdf_files/invoice_print.pdf"))
            Dim vscript As String = ""
            vscript = "<script>" & vbCrLf
            vscript = vscript + "window.open('Pdf_files/invoice_print.pdf', '_blank', 'resizable=yes,scrollbars=yes');" & vbCrLf
            vscript = vscript + "</script>"
            ScriptManager.RegisterStartupScript(Me, Me.GetType(), "xyz", vscript, False)
            connection.koneksi.CloseKoneksi()
        Catch ex As Exception
