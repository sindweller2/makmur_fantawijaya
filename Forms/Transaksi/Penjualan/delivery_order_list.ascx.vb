...
Partial Class Forms_Transaksi_Penjualan_delivery_order_list
    ...
    Private ReadOnly Property voption() As Integer
        Get
            ...
            If String.IsNullOrEmpty(o) = False Then Return CInt(o) Else Return 1
        End Get
    End Property
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " case"
            sqlcom = sqlcom + " when stock_delivery_order.is_submit = 'S' then 'Sudah'"
            sqlcom = sqlcom + " when stock_delivery_order.is_submit = 'B' then 'Belum'"
            ...
            ElseIf Me.dd_pilihan.SelectedValue = "2" Then
                If Me.dd_submit.SelectedValue = "B" Then
                    sqlcom = sqlcom + " and stock_delivery_order.is_submit = 'B'"
                Else
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Me.voption = 0 Or Me.voption = 1 Then
                Me.tb_search.Text = Me.vsearch
            ElseIf Me.voption = 2 Then
                Me.dd_submit.SelectedValue = Me.vsearch
            ElseIf Me.voption = 3 Then
                Me.dd_sts_terima.SelectedValue = Me.vsearch
            ElseIf Me.voption = 4 Then
                Me.dd_sts_kirim.SelectedValue = Me.vsearch
            End If
    ...
    Protected Sub btn_new_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_new.Click
        Response.Redirect("~/detil_delivery_order.aspx?vtahun=" & Me.tb_tahun.Text & "&vbulan=" & Me.bulan)
    End Sub
        ...
        Try
            For x As Integer = 0 To Me.dg_data.Items.Count - 1
                If CType(Me.dg_data.Items(x).FindControl("cb_data"), CheckBox).Checked = True Then
                    sqlcom = "delete stock_delivery_order"
    ...
    Protected Sub dg_data_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dg_data.ItemCommand
        If e.CommandName = "LinkItem" Then
            If Me.dd_pilihan.SelectedValue = 0 Or Me.dd_pilihan.SelectedValue = 1 Then
                Response.Redirect("~/detil_delivery_order.aspx?vno_do=" & CType(e.Item.FindControl("lbl_no"), Label).Text & "&vbulan=" & Me.bulan & "&vtahun=" & Me.tb_tahun.Text & "&voption=" & Me.dd_pilihan.SelectedValue & "&vsearch=" & Me.tb_search.Text & "&vpaging=" & Me.dg_data.CurrentPageIndex)
            ElseIf Me.dd_pilihan.SelectedValue = 2 Then
                Response.Redirect("~/detil_delivery_order.aspx?vno_do=" & CType(e.Item.FindControl("lbl_no"), Label).Text & "&vbulan=" & Me.bulan & "&vtahun=" & Me.tb_tahun.Text & "&voption=" & Me.dd_pilihan.SelectedValue & "&vsearch=" & Me.dd_submit.SelectedValue & "&vpaging=" & Me.dg_data.CurrentPageIndex)
            ElseIf Me.dd_pilihan.SelectedValue = 3 Then
                Response.Redirect("~/detil_delivery_order.aspx?vno_do=" & CType(e.Item.FindControl("lbl_no"), Label).Text & "&vbulan=" & Me.bulan & "&vtahun=" & Me.tb_tahun.Text & "&voption=" & Me.dd_pilihan.SelectedValue & "&vsearch=" & Me.dd_sts_terima.SelectedValue & "&vpaging=" & Me.dg_data.CurrentPageIndex)
            ElseIf Me.dd_pilihan.SelectedValue = 4 Then
                Response.Redirect("~/detil_delivery_order.aspx?vno_do=" & CType(e.Item.FindControl("lbl_no"), Label).Text & "&vbulan=" & Me.bulan & "&vtahun=" & Me.tb_tahun.Text & "&voption=" & Me.dd_pilihan.SelectedValue & "&vsearch=" & Me.dd_sts_kirim.SelectedValue & "&vpaging=" & Me.dg_data.CurrentPageIndex)
            End If
