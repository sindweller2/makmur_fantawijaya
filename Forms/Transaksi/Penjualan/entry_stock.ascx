<%@ Control Language="VB" AutoEventWireup="false" CodeFile="entry_stock.ascx.vb" Inherits="Forms_Transaksi_Sales_entry_stock" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Entry Stock Barang Gudang" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_nama_produk" Text="Nama produk" Width="250" Font-Names="Tahoma" Font-Size="8"/>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbl_nama_produk" Text='<%#Databinder.Eval(Container, "Dataitem.nama_beli") %>' Width="250" Font-Names="Tahoma" Font-Size="8"/>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_packaging" Text="Packaging" Width="150" Font-Names="Tahoma" Font-Size="8"/>
                        </HeaderTemplate>
                        <ItemTemplate>
