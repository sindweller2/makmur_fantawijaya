<%@ Control Language="VB" AutoEventWireup="false" CodeFile="transaksi_petty_cash.ascx.vb" Inherits="Forms_Transaksi_Collection_transaksi_petty_cash" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Daftar Transaksi Petty cash" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">   
    <tr>
        <td>
            <table runat="server" id="tbl_search" width="475">
                <tr>
                    <td><asp:DropDownList runat="server" ID="dd_pilihan" Font-Names="Tahoma" Font-Size="8" AutoPostBack="true">
                            ...
                            <asp:ListItem Text="Keterangan" Value="1"></asp:ListItem>
                        </asp:DropDownList>
            ...
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        ...
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbl_keterangan" Text='<%#Databinder.Eval(Container, "Dataitem.keterangan") %>' Width="200" Font-Names="Tahoma" Font-Size="8" />
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
