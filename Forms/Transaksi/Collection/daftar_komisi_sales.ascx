<%@ Control Language="VB" AutoEventWireup="false" CodeFile="daftar_komisi_sales.ascx.vb" Inherits="Forms_Transaksi_Collection_daftar_komisi_sales" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Daftar Penjualan Per Sales" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
    ...
    <tr>
        <td>
            <table runat="server" id="tbl_search">
                <tr>
                    <td><asp:Label runat="server" ID="lbl340" Text="Nama sales" Font-Names="Tahoma" Font-Size="8" />
        ...
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center">
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_total_nilai_idr" Text="Total nilai (IDR)" Width="150" Font-Names="Tahoma" Font-Size="8" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbl_total_nilai_idr" Text='<%#FormatNumber(Databinder.Eval(Container, "Dataitem.nilai_idr"),2) %>' Width="150" Font-Names="Tahoma" Font-Size="8" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="right" />
                    </asp:TemplateColumn>                    
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_total_nilai_usd" Text="Total nilai (USD)" Width="150" Font-Names="Tahoma" Font-Size="8" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbl_total_nilai_usd" Text='<%#FormatNumber(Databinder.Eval(Container, "Dataitem.nilai_usd"),2) %>' Width="150" Font-Names="Tahoma" Font-Size="8" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="right" />
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
...
<CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
    <Report FileName="reports\lap_komisi_sales.rpt"></Report>
