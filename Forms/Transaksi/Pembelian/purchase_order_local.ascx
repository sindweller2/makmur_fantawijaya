...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="purchase_order_local.ascx.vb" Inherits="Forms_Transaksi_Pembelian_purchase_order_local" %>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Pembelian Barang Lokal" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table> 
...
<table align="center">
    ...
    <tr>
        ...
        <td><asp:DropDownList runat="server" ID="dd_bulan" Font-Names="Tahoma" Font-Size="8" AutoPostBack="true"/>
            <asp:Button runat="server" ID="btn_new" Text="Pembelian lokal baru" Font-Names="Tahoma" Font-Size="8" />
        </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
...
<table align="center">
            ...
            <table runat="server" id="tbl_search" width="700">
                <tr>
                    <td><asp:DropDownList runat="server" ID="dd_pilihan" Font-Names="Tahoma" Font-Size="8" AutoPostBack="true">
                            ...
                            <asp:ListItem Text="Inv. pembelian" Value="1"></asp:ListItem>
                        </asp:DropDownList>
    ...
    <tr>
        <td>
            <asp:DataGrid SkinID="DGAPP" runat="server" ID="dg_data" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="center" Width="100%">
                <Columns>
                    <asp:TemplateColumn>
                        <ItemTemplate>
                    ...
                    <asp:TemplateColumn>
                        ...
                        <ItemTemplate>
                            <asp:LinkButton runat="server" ID="lbl_po_no_text" Text='<%#Databinder.Eval(Container, "Dataitem.po_no_text") %>' Width="100" Font-Names="Tahoma" Font-Size="8" CommandName="LinkItem" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="center" />
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lb_inv_pembelian" Text="Inv. pembelian" Width="100" Font-Names="Tahoma" Font-Size="8" />
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:LinkButton runat="server" ID="lbl_inv_pembelian" Text='<%#Databinder.Eval(Container, "Dataitem.inv_no") %>' Width="100" Font-Names="Tahoma" Font-Size="8" CommandName="LinkItem" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="center" />
                    </asp:TemplateColumn>
                    <asp:TemplateColumn>
