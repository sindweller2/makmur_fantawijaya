...
Partial Class Forms_Transaksi_Pembelian_daftar_lc
    ...
    Sub loadgrid()
        Try
            ...
            sqlcom = sqlcom + " order by lc.no_lc"
    ...
    Protected Sub btn_new_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_new.Click
        Response.Redirect("~/detil_lc.aspx?vtahun=" & Me.tb_tahun.Text & "&vbulan=" & Me.bulan)
    End Sub
    ...
    Protected Sub dg_data_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dg_data.ItemCommand
        If e.CommandName = "LinkPO" Or e.CommandName = "LinkLC" Then
            Response.Redirect("~/detil_lc.aspx?vno_lc=" & CType(e.Item.FindControl("lbl_seq"), Label).Text & "&vtahun=" & Me.tb_tahun.Text & "&vbulan=" & Me.bulan)
        End If
    End Sub
