<%@ Control Language="VB" AutoEventWireup="false" CodeFile="lap_sales_summary_by_salesname.ascx.vb" Inherits="Forms_Report_lap_sales_summary_by_salesname" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Laporan Sales Summary by Sales name" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
