<%@ Control Language="VB" AutoEventWireup="false" CodeFile="lap_omset_penjualan_perbulan.ascx.vb" Inherits="Forms_Report_lap_omset_penjualan_perbulan" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Laporan Omset Penjualan per Bulan" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
