<%@ Control Language="VB" AutoEventWireup="false" CodeFile="lap_sales_detail_by_goods.ascx.vb" Inherits="Forms_Report_lap_sales_detail_by_goods" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Laporan Sales Detail by Product" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
