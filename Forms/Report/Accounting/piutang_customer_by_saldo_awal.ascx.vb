...
Partial Class Forms_Report_Accounting_piutang_customer_by_saldo_awal
    ...
    '        sqlcom = "delete temp_piutang_customer_by_saldo_awal"
    ...
    '        sqlcom = "insert into temp_piutang_customer_by_saldo_awal(id_sales, id_customer, no_so_text, nama_customer,"
    ...
    Sub hapus_piutang()
        sqlcom = Nothing
        sqlcom = "delete from temp_piutang_customer_by_saldo_awal"
        connection.koneksi.DeleteRecord(sqlcom)
    End Sub
    ...
    Sub hitung_piutang_outstanding()
        Try
            ...
            sqlcom = "insert into temp_piutang_customer_by_saldo_awal(no_so_text, id_sales, id_customer, nama_customer,"
    ...
    Sub hapus_duplikat_data()
        Try
            ...
            sqlcom = sqlcom + " AS (SELECT [no_so_text],[nama_customer],[nama_sales],[tgl_invoice],[tgl_jatuh_tempo],[nilai_idr],[nilai_usd],[id_customer],[id_sales],[kurs],[nilai_saldo_awal],[nilai_invoice],[nilai_bayar],[nilai_retur], ROW_NUMBER() OVER(PARTITION BY [no_so_text],[nama_customer],[nama_sales],[tgl_invoice],[tgl_jatuh_tempo],[nilai_idr],[nilai_usd],[id_customer],[id_sales],[kurs],[nilai_saldo_awal],[nilai_invoice],[nilai_bayar],[nilai_retur] ORDER BY [no_so_text]) AS DuplicateCount FROM temp_piutang_customer_by_saldo_awal)"
    ...
    Sub print()
        Try
            If Me.RadioButtonPDF.Checked = True And Me.RadioButtonExcel.Checked = False Then
                ...
                reportPath = Server.MapPath("reports\lap_piutang_customer_by_saldo_awal.rpt")
                file_pdf = "Pdf_files/lap_piutang_customer_by_saldo_awal.pdf"
            ...
            ElseIf Me.RadioButtonPDF.Checked = False And Me.RadioButtonExcel.Checked = True Then
                ...
                '    sqlcom += " from temp_piutang_customer_by_saldo_awal"
                ...
                tradingClass.WriteExcel("~/Excel_files/lap_piutang_customer_by_saldo_awal.xls", DataTable, 1)
                tradingClass.OpenBrowser(Me.Page, "Excel_files/lap_piutang_customer_by_saldo_awal.xls", "800", "600", "no", "yes")
