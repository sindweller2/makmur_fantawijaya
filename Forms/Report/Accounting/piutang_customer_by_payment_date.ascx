<%@ Control Language="VB" AutoEventWireup="false" CodeFile="piutang_customer_by_payment_date.ascx.vb"
    Inherits="Forms_Report_Accounting_piutang_customer_by_payment_date" %>
...
<table align="center">
    <tr>
        <td>
            <asp:Label runat="server" ID="lbl11" Text="Laporan Piutang Customer by Payment Date"
...
<td>
    ...
    <tr>
            <td>
            <asp:Label runat="server" ID="Label2" Text="Result" Font-Names="Tahoma" Font-Size="8" /></td>
        <td>
            <asp:Label runat="server" ID="Label3" Text=":" Font-Names="Tahoma" Font-Size="8" /></td>
            <td>
            <asp:RadioButton runat="server" ID="RadioButtonDetail" Text="Detail" GroupName="result"
...
<CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
    <Report FileName="reports\lap_piutang_customer_by_payment_date.rpt">
    </Report>
