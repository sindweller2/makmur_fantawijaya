<%@ Control Language="VB" AutoEventWireup="false" CodeFile="piutang_customer.ascx.vb" Inherits="Forms_Report_Accounting_piutang_customer" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Laporan Piutang Customer" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    <tr>
        ...
        <act:CalendarExtender ID="ce_tgl_awal" TargetControlID="tb_tgl_awal" runat="server" Format="dd/MM/yyyy" ></act:CalendarExtender>
            ...
            <ajax:MaskedEditExtender runat="server" ID="MaskedEditExtender11" Mask="99/99/9999" MaskType="Date" TargetControlID="tb_tgl_awal" />
...
<table align="center">
    <tr>
        ...
        <td><asp:Button runat="server" ID="bt_closen" Text="Close" Font-Names="Tahoma" Font-Size="8" /></td>
    </tr>
</table>

<CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
    <Report FileName="reports\penerimaan_pembayaran_penjualan_piutang.rpt"></Report>
