...
Partial Class Forms_Report_lap_sales_detail_by_sales_cust_prod
    Inherits System.Web.UI.UserControl

    Protected Sub btn_print_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print.Click
        Try
            Dim reportPath As String = Server.MapPath("reports\lap_sales_detail_and_customer_and_produk.rpt")
            ...
            oRD.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Server.MapPath("Pdf_files/lap_sales_detail_and_customer_and_produk.pdf"))
            Dim vscript As String = ""
            vscript = "<script>" & vbCrLf
            vscript = vscript + "window.open('Pdf_files/lap_sales_detail_and_customer_and_produk.pdf', '_blank', 'resizable=yes,scrollbars=yes');" & vbCrLf
