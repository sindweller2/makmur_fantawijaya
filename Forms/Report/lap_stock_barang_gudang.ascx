<%@ Control Language="VB" AutoEventWireup="false" CodeFile="lap_stock_barang_gudang.ascx.vb" Inherits="Forms_report_lap_stock_barang_gudang" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Laporan Stock Barang Gudang" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl111" Text="Tahun" Font-Names="Tahoma" Font-Size="8"/></td>
    ...
    <tr>
        <td><asp:Label runat="server" ID="Label2" Text="Bulan" Font-Names="Tahoma" Font-Size="8"/></td>
...
<CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
    <Report FileName="reports\lap_stock_barang_gudang.rpt"></Report>
