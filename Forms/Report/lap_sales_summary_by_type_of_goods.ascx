<%@ Control Language="VB" AutoEventWireup="false" CodeFile="lap_sales_summary_by_type_of_goods.ascx.vb" Inherits="Forms_Report_lap_sales_summary_by_type_of_goods" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Laporan Sales Summary by Type of Goods" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>
