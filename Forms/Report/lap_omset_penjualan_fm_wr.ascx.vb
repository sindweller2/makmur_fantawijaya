...
Partial Class Forms_Report_lap_omset_penjualan_fm_wr
    Inherits System.Web.UI.UserControl

    Protected Sub btn_print_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print.Click
        Try
            Dim reportPath As String = Server.MapPath("reports\lap_omset_penjualan_fm_wr.rpt")
            ...
            oRD.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Server.MapPath("Pdf_files/lap_omset_penjualan_fm_wr.pdf"))
            Dim vscript As String = ""
            vscript = "<script>" & vbCrLf
            vscript = vscript + "window.open('Pdf_files/lap_omset_penjualan_fm_wr.pdf', '_blank', 'resizable=yes,scrollbars=yes');" & vbCrLf
