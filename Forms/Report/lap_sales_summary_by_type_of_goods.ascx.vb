...
Partial Class Forms_Report_lap_sales_summary_by_type_of_goods
    Inherits System.Web.UI.UserControl

    Protected Sub btn_print_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print.Click
        Try
            Dim reportPath As String = Server.MapPath("reports\lap_summary_by_type_of_goods.rpt")
            ...
            oRD.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Server.MapPath("Pdf_files/lap_summary_by_type_of_goods.pdf"))
            Dim vscript As String = ""
            vscript = "<script>" & vbCrLf
            vscript = vscript + "window.open('Pdf_files/lap_summary_by_type_of_goods.pdf', '_blank', 'resizable=yes,scrollbars=yes');" & vbCrLf
