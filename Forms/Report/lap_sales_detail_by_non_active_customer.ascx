<%@ Control Language="VB" AutoEventWireup="false" CodeFile="lap_sales_detail_by_non_active_customer.ascx.vb" Inherits="Forms_Report_lap_sales_detail_by_non_active_customer" %>
...
<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="lbl11" Text="Laporan Sales Detail by Non Active Customer" Font-Names="Tahoma" Font-Size="14" Font-Bold="true" /></td>
    </tr>
</table>

<table align="center">
    <tr>
        <td><asp:Label runat="server" ID="Label2" Font-Names="Tahoma" Font-Size="8" ForeColor="red" /></td>
    </tr>
</table>
...
<CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
    <Report FileName="reports\lap_sales_detail_by_non_active_customer.rpt"></Report>
