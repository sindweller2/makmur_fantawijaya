...
Partial Class Forms_Report_lap_daftar_customer
    Inherits System.Web.UI.UserControl

    Protected Sub btn_print_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print.Click
        Try
            Dim reportPath As String = Server.MapPath("reports\lap_daftar_customer.rpt")
            ...
            oRD.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Server.MapPath("Pdf_files/lap_daftar_customer.pdf"))
            Dim vscript As String = ""
            vscript = "<script>" & vbCrLf
            vscript = vscript + "window.open('Pdf_files/lap_daftar_customer.pdf', '_blank', 'resizable=yes,scrollbars=yes');" & vbCrLf
