...
<%@ Register Src="forms/PopUp/popup_dokumen_impor_bdp_produk.ascx" TagName="popup_dokumen_impor_bdp_produk" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub popup_dokumen_impor_bdp_produk1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_dokumen_impor_bdp_produk1_ProdukClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_dokumen_impor_bdp_produk1.id_produk)
        Me.ltl_js.Text += Me.CloseString
    End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_dokumen_impor_bdp_produk ID="popup_dokumen_impor_bdp_produk1" runat="server"  OnCloseClicked="popup_dokumen_impor_bdp_produk1_CloseClicked" OnProdukClicked="popup_dokumen_impor_bdp_produk1_ProdukClicked" />
</asp:Content>