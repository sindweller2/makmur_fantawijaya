...
<%@ Register Src="forms/PopUp/popup_so_do.ascx" TagName="popup_so_do" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub popup_so_do1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_so_do1_SOClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_so_do1.id_no_so)
        Me.ltl_js.Text += Me.CloseString
    End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_so_do ID="popup_so_do1" runat="server" OnCloseClicked="popup_so_do1_CloseClicked" OnSOClicked="popup_so_do1_SOClicked" />
</asp:Content>