<%@ Page Language="VB" MasterPageFile="~/popup_master.master" Title="Daftar Sample" %>

<%@ Register Src="forms/PopUp/popup_sample.ascx" TagName="popup_sample" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub popup_sample1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_sample1_SampleClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_sample1.id_sample)
        Me.ltl_js.Text += Me.CloseString
    End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_sample ID="popup_sample1" runat="server" OnCloseClicked="popup_sample1_CloseClicked" OnSampleClicked="popup_sample1_SampleClicked" />
</asp:Content>