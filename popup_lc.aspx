<%@ Page Language="VB" MasterPageFile="~/popup_master.master" Title="Daftar L/C" %>

<%@ Register Src="forms/PopUp/popup_lc.ascx" TagName="popup_lc" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub popup_lc1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_lc1_LcClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_lc1.seq_lc)
        Me.ltl_js.Text += Me.CloseString
    End Sub
       
    Private Function CreateJS(ByVal seq_lc As Integer) As String
        ...
        With js
            ...
            .Append("window.opener.document.getElementById('" & Me.TargetControlID & "').innerText = " & seq_lc & vbCrLf)
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_lc ID="popup_lc1" runat="server"  OnCloseClicked="popup_lc1_CloseClicked" OnLcClicked="popup_lc1_LcClicked" />
</asp:Content>