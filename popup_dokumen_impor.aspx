...
<%@ Register Src="forms/PopUp/popup_dokumen_impor.ascx" TagName="popup_dokumen_impor" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            Me.popup_dokumen_impor1.loadgrid()
        End If
    End Sub
    ...
    Protected Sub popup_dokumen_impor1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_dokumen_impor1_DokumenClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_dokumen_impor1.id_dokumen)
        Me.ltl_js.Text += Me.CloseString
    End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_dokumen_impor ID="popup_dokumen_impor1" runat="server" OnCloseClicked="popup_dokumen_impor1_CloseClicked" OnDokumenClicked="popup_dokumen_impor1_DokumenClicked" />
</asp:Content>