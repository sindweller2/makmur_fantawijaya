<%@ Page Language="VB" MasterPageFile="~/popup_master.master" Title="Daftar Purchase Order" %>

<%@ Register Src="forms/PopUp/popup_po.ascx" TagName="popup_po" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub popup_po1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_po1_POClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_po1.no_po)
        Me.ltl_js.Text += Me.CloseString
    End Sub
       
    Private Function CreateJS(ByVal no_po As String) As String
        ...
        With js
            ...
            .Append("window.opener.document.getElementById('" & Me.TargetControlID & "').innerText = '" & no_po & "'" & vbCrLf)
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_po ID="popup_po1" runat="server" OnCloseClicked="popup_po1_CloseClicked" OnPOClicked="popup_po1_POClicked" />
</asp:Content>