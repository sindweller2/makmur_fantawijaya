<%@ Page Language="VB" MasterPageFile="~/popup_master.master" Title="Daftar COA" %>

<%@ Register Src="forms/PopUp/popup_coa.ascx" TagName="popup_coa" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub popup_coa1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_coa1_COAClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_coa1.id_coa)
        Me.ltl_js.Text += Me.CloseString
    End Sub
       
    Private Function CreateJS(ByVal id_coa As String) As String
        ...
        With js
            ...
            .Append("window.opener.document.getElementById('" & Me.TargetControlID & "').innerText = '" & id_coa & "'" & vbCrLf)
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_coa ID="popup_coa1" runat="server" OnCloseClicked="popup_coa1_CloseClicked" OnCOAClicked="popup_coa1_COAClicked" />
</asp:Content>