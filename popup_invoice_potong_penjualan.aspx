<%@ Page Language="VB" MasterPageFile="~/popup_master.master" Title="Daftar Invoice Penjualan" %>

<%@ Register Src="forms/PopUp/popup_invoice_potong_penjualan.ascx" TagName="popup_invoice_potong_penjualan" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            Me.popup_invoice_potong_penjualan1.loadgrid()
        End If
    End Sub
    ...
    Protected Sub popup_invoice_potong_penjualan1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_invoice_potong_penjualan1_PenjualanClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_invoice_potong_penjualan1.no_so)
        Me.ltl_js.Text += Me.CloseString
    End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_invoice_potong_penjualan ID="popup_invoice_potong_penjualan1" runat="server"   OnCloseClicked="popup_invoice_potong_penjualan1_CloseClicked" OnPenjualanClicked="popup_invoice_potong_penjualan1_PenjualanClicked" />
</asp:Content>