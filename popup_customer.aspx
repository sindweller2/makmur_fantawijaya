...
<%@ Register Src="forms/PopUp/popup_customer.ascx" TagName="popup_customer" TagPrefix="uc1" %>
...
<script runat="server">
    ...
    Protected Sub popup_customer1_CloseClicked(ByVal sender As Object, ByVal e As System.EventArgs)
        Me.ltl_js.Text = Me.CloseString
    End Sub

    Protected Sub popup_customer1_CustomerClicked(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Me.ltl_js.Text = Me.CreateJS(Me.popup_customer1.id_customer)
        Me.ltl_js.Text += Me.CloseString
    End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">   
    ...
    <uc1:popup_customer ID="popup_customer1" runat="server"  OnCloseClicked="popup_customer1_CloseClicked" OnCustomerClicked="popup_customer1_CustomerClicked" />
</asp:Content>